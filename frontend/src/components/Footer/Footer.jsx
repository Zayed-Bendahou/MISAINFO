        ...
        <div className="justify-center">
          <div className="border-b -mb-4">
            <span className="text-sm text-gray-500 ">
              Misadat.ma est géré par la société
              <span className="text-white font-bold"> MISAINFO</span>
            </span>
          </div>
          <div className="flex">
            <span className="mt-4 items-center text-sm text-gray-500 ">
              ...
              <span className="text-white "> Identifiant Fiscal :</span>{' '}
              18767514 - <span className="text-white ">ICE :</span>{' '}
              001557090000019
            </span>
          </div>
        </div>
